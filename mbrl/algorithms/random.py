...
def generate_random_trajectories(
  ...
  # ------------------- Initialization -------------------
    print("Generation trajectories with random policy")
    ...
    mbrl.util.common.rollout_agent_trajectories(
        env,
        cfg.algorithm.environment_steps,
        ...
        while not done:
            ...
            if env_steps % cfg.algorithm.freq_train_model == 0:
                ...
                logger.log_data(
                    ...
                    {"env_step": cfg.algorithm.initial_exploration_steps+env_steps, 
                    "in_domain_accuracy": in_domain_accuracies[0],
                    "in_domain_accuracy_ste": in_domain_accuracies[1],
                    "random_accuracy": random_domain_accuracies[0],
                    "random_accuracy_ste": random_domain_accuracies[1],
                    },
                    )
            ...
            if debug_mode: print(f"Step {env_steps}: Reward {reward:.3f}.")
